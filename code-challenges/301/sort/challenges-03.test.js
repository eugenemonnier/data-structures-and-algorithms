...
const sortByLength = (arr) => {
  // Solution code here...
  arr.sort((a,b) => { return a.length > b.length ? 1 : a.length < b.length ? -1 : 0; });
  return arr;
};
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  arr.sort((a,b) => { return a.toLowerCase() > b.toLowerCase() ? 1 : a.toLowerCase() < b.toLowerCase() ? -1 : 0; });
  return arr;
};
...
const sortNumbersByLength = (arr) => {
  arr.sort((a,b) => { return a.toString().length > b.toString().length ? 1 : a.toString().length < b.toString().length ? -1 : 0; });
  return arr;
};
...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort((a,b) => { return a.lastName > b.lastName ? 1 : a.lastName < b.lastName ? -1 : 0; });
  return arr;
};
...
const sortSchedule = (arr) => {
  ...
  arr.sort((a,b) => {
    let dayA = a.dayOfWeek;
    let dayB = b.dayOfWeek;
    let lengthA = a.end - a.start;
    let lengthB = b.end - b.start;
    let returnVal;
    a.dayOfWeek === b.dayOfWeek ? returnVal = lengthA - lengthB : returnVal = days[dayA] - days[dayB];
    return returnVal;
  });
  return arr;
};
