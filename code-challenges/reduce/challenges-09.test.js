...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((namesSoFar, person, index) => {
    namesSoFar[index] = person.name;
    return namesSoFar;
  }, []);
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  return arr.reduce((stat, curStat) => {
    statName === curStat.stat.name ? stat = curStat : null;
    return stat;
  }, {});
};
